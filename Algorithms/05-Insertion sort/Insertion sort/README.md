...
Iteration 2:<br>
Now in second iteration we will compare element at index 2 with it's LHS element. So 4 is less than 2? No this is false 
...
Iteration 3:<br>
In this iteration we will check element at index 3 to its LHS elements. i.e. we will check 1 with. Now 1 is less than 4 
