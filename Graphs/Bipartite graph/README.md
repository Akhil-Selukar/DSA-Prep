...
2. Cyclic graphs where length of cycle is even number will always be bipartite.
3. Cyclic graphs where length of cycle is odd number will never be bipartite.